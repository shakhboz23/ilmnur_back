...
async function sendSMS(phone, message) {
    try {
        ...
        const config = {
            ...
            headers: Object.assign(Object.assign({}, data.getHeaders()), { Authorization: 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MTYxODU4NTIsImlhdCI6MTcxMzU5Mzg1Miwicm9sZSI6InRlc3QiLCJzaWduIjoiZGRiNzc5NDM1OGMyNDgzYmFjMWFiYjEzNTkxMDYyMWE2MDJhZTJjMjczZWM3M2U4ZGQ2NjA0OWFiNGE5YWJmNiIsInN1YiI6IjcwODAifQ.81vIEsNdZu1Tkzz15jYwpFww-jsxOvqVvNycmTFNmiM' }),
            data,
        };
        axios(config)
